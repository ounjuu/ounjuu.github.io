  ...
  const projects = [
    {
      ...
      live: true,
      desc: '반복되던 사내 사무 업무를 직접 만든 웹 도구로 줄였습니다. 엑셀로 관리하던 거래처 요청서·동영상 프로세스를 통합 웹 시스템으로 옮기고, 키오스크 앱 로그를 브라우저에서 바로 분석하는 도구를 만들었습니다. 현재는 지출결의서 작성·그룹웨어·세금계산서 발행 신청까지 자동화를 넓혀가고 있습니다. Claude를 페어로 활용해 설계와 구현 속도를 끌어올렸습니다.',
      ...
      highlights: [
        ...
        '지출결의서 작성 · 그룹웨어 · 세금계산서 발행 신청 자동화 진행 중',
      ...
      features: [
        ...
        { title: '사무 자동화 (진행 중)', desc: '지출결의서 작성 · 그룹웨어 · 세금계산서 발행 신청 프로세스를 자동화' },
